...
var SpanI = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].a(_templateObject(), Media.md(_templateObject2()));

function ActiveLink(props) {
  // const {icon,asPath} = props;
  return;

  __jsx("li", null, __jsx("div", null, __jsx(Link, {
    route: "/"
  }, __jsx(SpanI, {
    className: "nav-link ".concat(props.asPath === '/' && 'active'),
    style: linkStyle
  }, "Trang Ch\u1EE7"))));
}
...
//# sourceMappingURL=tu-dien.js.a12180790f15a173dbb6.hot-update.js.map