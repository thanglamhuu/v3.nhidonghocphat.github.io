...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(Home, [{
    ...
    value: function render() {
      ...
      console.log(this.state); // let books = '';
      // if(list) {
      //   books = list.map((item)=>{
      ...
      }, "Trang Ch\u1EE7"), __jsx(WrapDanhSachBookCom, null, baiHocs.length), __jsx(DivLesson, null, __jsx(DivList, null)));
    }
  }], [{
    key: "getInitialProps",
...
//# sourceMappingURL=index.js.41c69b3d7a579a9bf656.hot-update.js.map