  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_8__["default"])(Home, [{
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          luyenDichs = _this$state.luyenDichs; // let books = '';
      // if(list) {
      //   books = list.map((item)=>{
      ...
      }, "Danh s\xE1ch s\xE1ch h\u1ECDc"), __jsx(WrapDanhSachBookCom, null, baiHocs.length), __jsx(DivLesson, null, __jsx(DivList, null), content));
    }
  }], [{
    key: "getInitialProps",
...
//# sourceMappingURL=index.js.7f590cc33b3440fcdeb6.hot-update.js.map